...
exports.deleteAll = function(req, res) {
    ...
    common.vector_model.find(function(err, vectors) {
        if (err) {res.send(err)};

        vectors.forEach(function(vector){
            common.vector_model.remove({_id: vector._id},
            function(err){
                if (err) {res.send(err)};
            })
        });
...
exports.addNew = function(req, res) {
    ...
    var vector = new common.vector_model(); 
    ...
    vector.parent = (vector.parent, req.body, "parent");
    vector.translation_fragment = common.jsonFieldEqual(vector.translation_fragment, req.body, "translation_fragment");
    vector.transcription_fragment = common.jsonFieldEqual(vector.transcription_fragment, req.body, "transcription_fragment");
    vector.OCD = common.jsonFieldEqual(vector.OCD, req.body, "OCD");
    vector.creator = common.jsonFieldEqual(vector.creator, req.body, "creator");
...
exports.updateOne = function(req, res) {
    ...
    var updateDoc = common.vector_model.findById(req.params.vector_id); 
    updateDoc.exec(function(err, vector) {
        if (err) {res.send(err)};

        jsonFieldPush(req.body, "metadata");
        jsonFieldPush(req.body, "children");
        vector.parent = common.jsonFieldEqual(vector.parent, req.body, "parent");
        vector.translation_fragment = common.jsonFieldEqual(vector.translation_fragment, req.body, "translation_fragment");
        vector.transcription_fragment = common.jsonFieldEqual(vector.transcription_fragment, req.body, "transcription_fragment");
        vector.OCD = common.jsonFieldEqual(vector.OCD, req.body, "OCD");
        vector.creator = common.jsonFieldEqual(vector.creator, req.body, "creator");
...
exports.searchByIds = function(req, res) {
    ...
    var otherSearch = common.vector_model
    .find()
...
exports.searchByParent = function(req,res) {
    ...
    var theSearch = common.vector_model
    .find()
    .populate('parent')
