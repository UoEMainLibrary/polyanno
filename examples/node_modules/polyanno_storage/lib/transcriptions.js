...
exports.voting = function(req, res) {
    ...
    var voteOn = setup.transcription_model.findOne({'body.id':req.body.parent});
...
var votingInfoTexts = function(targetID, textArray, res) {
    ...
    var parent_id = parentID.split("transcriptions/")[0];
    var spanID = parts[1];
...
exports.searchByIds = function(req, res) {
    ...
    var otherSearch = setup.transcription_model.find( { 'id' : { $in : theArray } } );
    otherSearch.exec(function(err, texts){
        ...
        if (err) {
            ...
            return ({list: bracketedArray(ids)});
        };
    });
};
